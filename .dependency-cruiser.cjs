...
module.exports = {
  forbidden: [
    ...
    },
    {
      ...
      to: { path: "^packages/(runtime-browser|conformance|model-gateway|agent-tools|agent-core|lang-python|runtime-wasi)/src" },
    },
    {
      ...
      severity: "error",
      from: { path: "^packages/(lang-[^/]+|runtime-wasi)/src", pathNot: "\\.test\\.ts$" },
