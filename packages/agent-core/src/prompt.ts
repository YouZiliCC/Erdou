...
const ERDOU_ABOUT = [
  ...
  "- Erdou ships SKILLS — task playbooks under /.skills/<name>/SKILL.md (e.g. making a PowerPoint/Word/Excel/PDF file). Available ones are named in a SKILLS section when present, or list /.skills/ yourself; when your task matches one, read that file FIRST and follow it. You can add your own by dropping a folder there.",
